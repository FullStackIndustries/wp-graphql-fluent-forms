###############################################################################
# Pre-configured WordPress Installation w/ WPGraphQL, and WPGraphQL for Plugin Name #
# For testing only, use in production not recommended. #
# Forked from https://github.com/wp-graphql/wp-graphql/blob/d38d5a9194c90d1ea7f1e554f684bc8d389759d6/docker/app.Dockerfile
###############################################################################
...
ENV PROJECT_DIR="${PLUGINS_DIR}/wp-graphql-fluent-forms"
