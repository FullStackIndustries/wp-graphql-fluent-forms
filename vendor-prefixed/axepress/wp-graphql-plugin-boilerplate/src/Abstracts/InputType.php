...
use WPGraphQL\FluentForms\Vendor\AxeWP\GraphQL\Interfaces\TypeWithInputFields;

if ( ! class_exists( '\WPGraphQL\FluentForms\Vendor\AxeWP\GraphQL\Abstracts\InputType' ) ) {
